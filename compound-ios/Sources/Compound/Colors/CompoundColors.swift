...
public class CompoundColors {
    ...
    /// Flox: Telegram-style incoming bubble — white/light gray
    @available(iOS, deprecated: 100000.0, message: "This token should be generated by now.")
    public let _bgBubbleIncoming = Color(UIColor { $0.isLight
        ? UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)       // #FFFFFF — white
        : UIColor(red: 0.17, green: 0.17, blue: 0.18, alpha: 1.0)    // #2C2C2E — dark gray
    })
    /// Flox: Telegram-style outgoing bubble — light teal
    @available(iOS, deprecated: 100000.0, message: "This token should be generated by now.")
    public let _bgBubbleOutgoing = Color(UIColor { $0.isLight
        ? UIColor(red: 0.88, green: 0.97, blue: 0.94, alpha: 1.0)    // #E0F7F1 — light teal
        : UIColor(red: 0.11, green: 0.37, blue: 0.31, alpha: 1.0)    // #1B5E50 — dark teal
    })
    /// This token is a placeholder and hasn't been finalised.
    @available(iOS, deprecated: 100000.0, message: "This token should be generated by now.")
